    ...
    <div class="app-content">
        <div class="container-fluid">
            ...
            <div class="row g-4">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="card h-100 shadow-sm hover-shadow" style="cursor: pointer;"
                                ...
                                <div class="card-body text-center">
                                    <div class="mb-3">
                                        <i class="bi bi-bus-front" style="font-size: 3rem; color: #0d6efd;"></i>
                                    </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 shadow-sm border-dashed" style="cursor: pointer; border: 2px dashed #0d6efd;"
                        onclick="abrirModalNuevoTipoBus()">
                        <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                            <i class="bi bi-plus-circle" style="font-size: 4rem; color: #0d6efd;"></i>
                            <h5 class="mt-3 text-primary">Agregar Nuevo Tipo</h5>
                        </div>
                    </div>
                </div>
            </div>
