...
$maxGrupo = max(array_map(fn($g) => (float) $g->ingresos, $data['por_grupo']) ?: [0]);
$maxRuta = max(array_map(fn($r) => (int) $r->boletos, $data['rutas']) ?: [0]);
...
<style>
    ...
    .kpi { background: var(--color-card-bg); border: 1px solid var(--color-border); border-radius: var(--radius-card); padding: 1rem 1.15rem; display: flex; flex-direction: column; gap: .35rem; }
    .kpi-label { font-size: .74rem; font-weight: 700; letter-spacing: .06em; text-transform: uppercase; color: var(--color-text-muted); display: flex; align-items: center; gap: .4rem; }
    .kpi-valor { font-size: 1.75rem; font-weight: 800; line-height: 1.1; font-variant-numeric: tabular-nums; color: var(--color-text); }
    .kpi-nota { font-size: .82rem; color: var(--color-text-muted); }
    .delta { font-weight: 700; }
    .delta.sube { color: #059669; }
    .delta.baja { color: #dc2626; }
...
<main class="app-main">
    ...
    <div class="app-content">
        <div class="container-fluid d-grid gap-3">
            ...
            <!-- Indicadores -->
            <section class="kpis" aria-label="Indicadores del periodo">
                <div class="kpi">
                    <div class="kpi-label"><i class="bi bi-cash-coin"></i> Ingresos por pasajes</div>
                ...
                <div class="kpi">
                    <div class="kpi-label"><i class="bi bi-ticket-perforated"></i> Boletos vendidos</div>
                ...
                <div class="kpi">
                    <div class="kpi-label"><i class="bi bi-people"></i> Ocupación de buses</div>
                ...
                <div class="kpi">
                    <div class="kpi-label"><i class="bi bi-box-seam"></i> Encomiendas</div>
